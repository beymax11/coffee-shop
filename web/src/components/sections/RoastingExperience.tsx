...
export const RoastingExperience: React.FC = () => {
  return (
    <section className="py-24 bg-[#0B0B0B] border-t border-white/5 relative">
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <FadeUp className="relative h-[480px] rounded-2xl overflow-hidden group">
            ...
            {/* Overlay Glass Card */}
            <div className="absolute bottom-6 left-6 right-6 p-6 rounded-xl bg-black/60 border border-white/10 backdrop-blur-md">
          ...
          <div className="space-y-6">
            <FadeUp>
              ...
              <h2 className="type-h2 text-white mt-2 leading-snug">
            ...
            <FadeUp delay={0.2} className="pt-4 flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h5 className="type-label text-white">Award-Winning Blends</h5>
                  <p className="type-caption text-zinc-500">Cup of Excellence Gold</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <div className="rounded-full bg-brand-gold/10 p-2 text-brand-gold">
                ...
                <div>
                  <h5 className="type-label text-white">Direct Sourcing</h5>
                  <p className="type-caption text-zinc-500">Ethical Fair-Trade Microlots</p>
                </div>
              </div>
            </FadeUp>
