...
const EXPERIENCES: CoffeeExperience[] = [
  {
    ...
    features: [
      ...
      "Complimentary welcome pour of our signature reserve",
      "Full menu and patisserie service access",
    ],
    image: "/res.jpg",
    metrics: [
      { label: "Capacity", value: "1 to 4 Guests" },
      { label: "Pricing", value: "$45 / Table" },
      { label: "Includes", value: "Welcome Pour" },
    ],
  },
  {
    id: "cart",
    ...
    description:
      "Sponsor our premium copper & brass espresso cart directly at weddings, corporate galas, or private product launches. Staffed by two certified master baristas serving our full espresso, signature cold smoked drinks, and custom creations.",
    features: [
      "2 certified master baristas and full setup",
      "Unlimited specialty drinks and espresso-based beverages",
      "Custom foam stencils and personalized branding options",
    ],
    image: "/cart.jpg",
    metrics: [
      { label: "Catering Staff", value: "2 Master Baristas" },
      { label: "Menu Options", value: "Unlimited Specialty" },
      { label: "Pricing", value: "Bespoke Quote" },
    ],
  },
];
