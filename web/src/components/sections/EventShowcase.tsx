  ...
  return (
    <section className="py-24 bg-[#0B0B0B] relative">
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        <div className="rounded-2xl border border-white/5 bg-[#111111] p-8 md:p-16 relative overflow-hidden flex flex-col md:flex-row items-center gap-12 glassmorphism-gold shadow-2xl">
          ...
          <div className="flex-1 space-y-6">
            ...
            <ul className="space-y-2 type-body-sm text-zinc-400">
          ...
          {/* Right Photo */}
          <div className="w-full md:w-[400px] h-80 rounded-xl overflow-hidden border border-white/5 shrink-0">
            <img
