      ...
      <div className="min-h-screen bg-[#0B0B0B] py-16 md:py-24 text-[#F5F5F0]">
        ...
        <div className="relative h-[400px] w-full flex items-center justify-center overflow-hidden mb-20">
          ...
          <div className="relative z-10 text-center max-w-2xl px-6 space-y-4">
            <span className="type-eyebrow">L'OR NOIR Story</span>
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-8 space-y-28">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <h2 className="type-h2 text-white leading-snug">
            ...
            <div className="relative h-[380px] rounded-2xl overflow-hidden border border-white/5 shadow-xl group">
              <img
          ...
          <div className="space-y-12">
            <div className="text-center max-w-xl mx-auto">
              ...
              <h2 className="type-h2 text-white mt-1">Our Core Pillars</h2>
            </div>
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {values.map((v, i) => {
                const Icon = v.icon;
                return (
                  <StaggerItem key={i} className="rounded-xl border border-white/5 bg-[#141414] p-8 space-y-4 hover:border-brand-gold/20 transition-all">
                    <div className="rounded-full bg-brand-gold/10 p-3 text-brand-gold w-fit">
                      <Icon size={20} />
                    </div>
                    <h3 className="type-subheading text-white">{v.title}</h3>
                    <p className="type-body text-zinc-400">{v.desc}</p>
                  </StaggerItem>
                );
              })}
            </StaggerContainer>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-6 lg:sticky lg:top-28">
              ...
              <h2 className="type-h2 text-white">Chronological Growth</h2>
              <p className="type-body text-zinc-400">
            ...
            <div className="border-l border-white/10 pl-8 space-y-12">
              {timeline.map((item, idx) => (
                <div key={idx} className="relative space-y-2">
                  {/* Dot */}
                  <div className="absolute -left-[37px] top-1 h-3.5 w-3.5 rounded-full border-2 border-brand-gold bg-[#0B0B0B]" />
                  
                  <span className="type-eyebrow">{item.year}</span>
                  <h4 className="type-subheading text-white">{item.title}</h4>
                  <p className="type-body text-zinc-400">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-white/5 bg-[#141414] p-8 md:p-12 relative overflow-hidden glassmorphism-gold">
            ...
            <div className="text-center max-w-xl mx-auto mb-12">
              ...
              <h2 className="type-h2-alt text-white mt-1">The Coffee Ceremony</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {processes.map((p, idx) => (
                <div key={idx} className="space-y-3 relative">
                  ...
                  <h4 className="type-label text-white">{p.title}</h4>
                  <p className="type-caption text-zinc-500">{p.desc}</p>
                </div>
              ))}
            </div>
          </div>
