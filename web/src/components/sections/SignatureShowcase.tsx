...
export const SignatureShowcase: React.FC<SignatureShowcaseProps> = ({ onQuickView }) => {
  ...
  return (
    <section className="py-28 bg-background-alt dark:bg-[#0a0a0a] text-foreground dark:text-white relative border-y border-card-border dark:border-zinc-900 transition-colors duration-500 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-[450px] h-[450px] bg-brand-gold/5 rounded-full filter blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[450px] h-[450px] bg-brand-gold/5 rounded-full filter blur-[120px] pointer-events-none" />
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between mb-20 gap-8">
          <div className="max-w-2xl">
            <div className="flex items-center gap-2 mb-3">
              <Film size={12} className="text-brand-gold animate-pulse" />
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-3 left-3 w-3 h-3 border-t border-l border-brand-gold/40 transition-colors duration-300 group-hover:border-brand-gold" />
                  <div className="absolute top-3 right-3 w-3 h-3 border-t border-r border-brand-gold/40 transition-colors duration-300 group-hover:border-brand-gold" />
                  <div className="absolute bottom-3 left-3 w-3 h-3 border-b border-l border-brand-gold/40 transition-colors duration-300 group-hover:border-brand-gold" />
                  <div className="absolute bottom-3 right-3 w-3 h-3 border-b border-r border-brand-gold/40 transition-colors duration-300 group-hover:border-brand-gold" />
                ...
                >
                  <div>
                    ...
                    {/* Drink Title */}
                    <h3 className="text-xl font-serif font-semibold text-foreground dark:text-zinc-100 mt-3 group-hover:text-brand-gold transition-colors duration-300">
                      {item.name}
                    </h3>
                    ...
                    {item.notes && (
                      <div className="mt-4 pt-4 border-t border-card-border dark:border-zinc-900 flex flex-col gap-1.5 bg-background-alt/30 dark:bg-zinc-950/20 rounded-md">
                        <span className="text-[9px] uppercase tracking-[0.15em] text-brand-gold font-mono font-bold">
                          Director's Notes
                        </span>
